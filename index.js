const sessionName = "Abdulhafizk";
const donationLink = "https://saweria.co/sansekai";
const owner = ["6282247134797"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(
        color(
          "Donate to support the creator: https://saweria.co/sansekai",
          "yellow"
        )
      );
